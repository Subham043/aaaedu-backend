                            ...
                            <div class="table-responsive table-card mt-3 mb-1">
                                ...
                                <table class="table align-middle table-nowrap" id="customerTable">
                                    <thead class="table-light">
                                        <tr>
                                            <th class="sort" data-sort="customer_name">Question No.</th>
                                            <th class="sort" data-sort="customer_name">Marks</th>
                                            <th class="sort" data-sort="customer_name">Negative Marks</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    @can('edit tests')
                                                    <div class="edit">
                                                        <a href="{{route('test.questionarie.paginate.get', [$test_id, $item->id])}}" class="btn btn-sm btn-warning edit-item-btn">Questionarie</a>
                                                    </div>
                                                    @endcan
