...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list events')
        @include('admin.includes.breadcrumb', ['page'=>'Test Questionarie', 'page_link'=>route('test.questionarie.paginate.get', [$test_id, $quiz_id]), 'list'=>['Create']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('test.questionarie.create.post', [$test_id, $quiz_id])}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('test.questionarie.create.post', [$test_id, $quiz_id])}}', formData)
