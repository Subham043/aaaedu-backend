...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list events')
        @include('admin.includes.breadcrumb', ['page'=>'Test', 'page_link'=>route('test.test.paginate.get'), 'list'=>['Create']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('test.test.create.post')}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-lg-4 col-md-12">
                                        <div class="mt-4 mt-md-0">
                                            <div>
                                                <div class="form-check form-switch form-check-right mb-2">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="is_admission" name="is_admission">
                                ...
                                <div class="row gy-4" id="image_row">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="mt-4 mt-md-0">
                                            <div>
                                                <div class="form-check form-switch form-check-right mb-2">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="is_paid" name="is_paid" checked>
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('test.test.create.post')}}', formData)
