...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list campaigns')
        @include('admin.includes.breadcrumb', ['page'=>'Course', 'page_link'=>route('course.course.paginate.get'), 'list'=>['Update']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row" id="image-container">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('course.course.update.post', $data->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-6 col-md-6">
                                        @include('admin.includes.select', ['key'=>'classChoice', 'label'=>'Class'])
                                    </div>
                                    <div class="col-xxl-6 col-md-6">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('course.course.update.post', $data->id)}}', formData)
    ...
    choices: [
        {
            ...
            selected: {{ $data->class->value=='School (STD VIII to X)' ? 'true' : 'false'}}
        },
        {
        ...
        @foreach($branch as $branch)
            {
                value: '{{$branch->id}}',
                label: '{{$branch->name}}',
                selected: {{ (in_array($branch->id, $branches)) ? 'true' : 'false'}}
            },
        @endforeach
    ],
