...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list campaigns')
        @include('admin.includes.breadcrumb', ['page'=>'Campaign', 'page_link'=>route('campaign.campaign.paginate.get'), 'list'=>['Update']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row" id="image-container">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('campaign.campaign.update.post', $data->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                            ...
                            <div class="live-preview">
                                <div class="row gy-4" id="image_row">
                                    <div class="col-xxl-6 col-md-6">
                                        @include('admin.includes.input', ['key'=>'testimonial_heading', 'label'=>'Heading', 'value'=>$data->testimonial_heading])
                                    </div>
                                    <div class="col-xxl-6 col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4" id="image_row">
                                    <div class="col-xxl-6 col-md-6">
                                        @include('admin.includes.input', ['key'=>'achiever_heading', 'label'=>'Heading', 'value'=>$data->topper_heading])
                                    </div>
                                    <div class="col-xxl-6 col-md-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4" id="image_row">
                                    <div class="col-xxl-12 col-md-12">
                                        @include('admin.includes.input', ['key'=>'form_heading', 'label'=>'Heading', 'value'=>$data->form_heading])
                                    </div>
                                    <div class="col-lg-4 col-md-12">
                                        <div class="mt-4 mt-md-0">
                                            <div>
                                                <div class="form-check form-switch form-check-right mb-2">
                                                    <input class="form-check-input" type="checkbox" role="switch" id="include_form" name="include_form" {{$data->include_form==false ? '' : 'checked'}}>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4" id="image_row">
                                    <div class="col-xxl-4 col-md-4">
                                        @include('admin.includes.file_input', ['key'=>'image', 'label'=>'Image (1429 x 600)'])
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('campaign.campaign.update.post', $data->id)}}', formData)
