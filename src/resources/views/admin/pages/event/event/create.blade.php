...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list events')
        @include('admin.includes.breadcrumb', ['page'=>'Event', 'page_link'=>route('event.event.paginate.get'), 'list'=>['Create']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('event.event.create.post')}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-4 col-md-4">
                                        @include('admin.includes.date', ['key'=>'event_date', 'label'=>'Event Date', 'value'=>old('event_date')])
                                    </div>
                                    <div class="col-xxl-4 col-md-4">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('event.event.create.post')}}', formData)
