...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @include('admin.includes.breadcrumb', ['page'=>'Enquiries', 'page_link'=>route('job_opening.job_enquiry.paginate.get', $job_id), 'list'=>['List']])
        <!-- end page title -->
                    ...
                    <div class="card-body">
                        <div id="customerList">
                            <div class="row g-4 mb-3">
                                ...
                                <div class="col-sm">
                                    @include('admin.includes.search_list', ['link'=>route('job_opening.job_enquiry.paginate.get', $job_id), 'search'=>$search])
                                </div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    ...
                                                    @can('delete events')
                                                    <div class="remove">
                                                        <button class="btn btn-sm btn-danger remove-item-btn" data-link="{{route('job_opening.job_enquiry.delete.get', [$job_id, $item->id])}}">Delete</button>
                                                    </div>
                                                    @endcan
                                                </div>
                                            </td>
