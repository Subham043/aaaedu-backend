                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 22px;">Online Test Reciept.</span></p>
                                                    <p
                                                        style="font-size: 15px; line-height: 1.2; mso-line-height-alt: 26px; margin: 0;text-align:center">
                                                        <span style="font-size: 15px;">Thank you for enrolling. Your online test enrollment is completed. The details given below is the reciept of the enrollment.</span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div
                                                ...
                                                <div
                                                   ...
                                                   <table width="100%" border="1" style="text-align:center">
                                                        ...
                                                        @if($data['enrollment_type']->value==='Purchased')
                                                        <tr>
                                                            <th>Amount Paid</th>
                                                            <td>{{ $data['amount'] }}</td>
                                                        </tr>
