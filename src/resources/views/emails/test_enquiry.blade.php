                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 22px;">Online Test Enquiry.</span></p>
                                                    <p
                                                        style="font-size: 15px; line-height: 1.2; mso-line-height-alt: 26px; margin: 0;text-align:center">
                                                        <span style="font-size: 15px;">The details given below has been provided to us by {{ $data['user']->name }}</span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
