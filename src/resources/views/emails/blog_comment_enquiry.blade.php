...
<body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #eaeaea;">
    ...
    <table bgcolor="#B8CCE2" cellpadding="0" cellspacing="0" class="nl-container" role="presentation"
        style="table-layout: fixed; vertical-align: top; min-width: 320px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #eaeaea; width: 100%;"
                ...
                <td style="word-break: break-word; vertical-align: top;" valign="top">
                            ...
                            <div style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;">
                                ...
                                <div class="col num12"
                                    ...
                                    <div style="width:100% !important;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="border-top:0px solid #A17A7A; border-left:0px solid #000000; border-bottom:1px solid #ABA3A3; border-right:0px solid #786C6C; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 20px;">
                                            <!--<![endif]-->
                                            <div align="center" class="img-container left fixedwidth"
                                                ...
                                                <div style="font-size:1px;line-height:25px"> </div><img alt="Image"
                            ...
                            <div style="border-collapse: collapse;display: table;width: 100%;background-color:#FFFFFF;">
                                ...
                                <div class="col num12"
                                    ...
                                    <div style="width:100% !important;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:15px; padding-bottom:15px; padding-right: 35px; padding-left: 35px;">
                                            <!--<![endif]-->
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        <span style="font-size: 22px;">Blog Comment Received.</span></p>
                                                    <p
                                                        style="font-size: 15px; line-height: 1.2; mso-line-height-alt: 26px; margin: 0;text-align:center">
                                                        <span style="font-size: 15px;">The details given below has been provided to us by {{ $data['name'] }}</span></p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
                                            ...
                                            <div
                                                ...
                                                <div
                                                   ...
                                                   <table width="100%" border="1" style="text-align:center">
                                                        ...
                                                        <tr>
                                                            <th>Frontend Link</th>
                                                            <td>{{config('app.frontend_url')}}/knowledge-desk/{{ $data['blog']->slug }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th>Admin Link</th>
                                                            <td>{{route('blog.comment.paginate.get', $data['blog']->id)}}</td>
                                                        </tr>
                                                   </table>
                                                </div>
                                            </div>
                    ...
                    <div style="background-color:transparent;">
                        <div class="block-grid two-up no-stack"
                            style="Margin: 0 auto; min-width: 320px; max-width: 600px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word; background-color: #354620;">
                            <div style="border-collapse: collapse;display: table;width: 100%;background-color:#354620;">
                                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:transparent;"><tr><td align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px"><tr class="layout-full-width" style="background-color:#354620"><![endif]-->
                                ...
                                <div class="col num6"
                                    style="max-width: 100%; min-width: 100%; display: table-footer-group; vertical-align: top; width: 100%;">
                                    <div style="width:100% !important;">
                                        <!--[if (!mso)&(!IE)]><!-->
                                        <div
                                            ...
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    <p
                                                        ...
                                                        © {{ date('Y') }} <a href="{{config('app.frontend_url')}}"
                                                            style="color: white;"> {{config('app.name')}} </a>&nbsp; All rights
                                                        reserved.</p>
                                                </div>
                                            </div>
                                            <!--[if mso]></td></tr></table><![endif]-->
